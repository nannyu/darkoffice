...
| 幕 | 标题 | 角色 | 核心事件 | narrative_bridge |
|---|------|------|---------|-----------------|
| 1 | 温水 | 商人李某 | 红包试探 | 你刚调任国企董事长，商人李某开始频繁出现在你身边。今天他塞给你一个信封，说是过节费。 |
| 2 | 围猎 | 商人李某 | 工程邀请 + 倒签文件 | 李某的饭局越来越频繁，提到一个上亿的大项目。同时财务那边也开始找你倒签文件。 |
| 3 | 捆绑 | 副市长杨 | 项目审批 + 入股提议 | 副市长亲自过问那个项目。与此同时，李某递来一份股权协议——"不用出钱，算你技术入股"。 |
| 4 | 裂痕 | 商人李某 | 攻守同盟 + 审计压力 | 审计的风声越来越紧。李某变了脸："咱们是一条船上的人，你别想抽身。" |
| 5 | 坠落 | 纪委调查员 | 约谈通知 + 证据出示 | 纪委的通知来了。调查员推过来一摞材料：银行流水、股权协议、工程合同…… |
